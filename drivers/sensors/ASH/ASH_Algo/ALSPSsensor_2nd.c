...
static int proximity_set_threshold(void)
{
	...
	ret = psensor_factory_read_high(PSENSOR_HI_CALIBRATION_FILE_2ND, &g_i2c_client->dev);

	/*For transition period from 3/5 to 2/4 +++*/
	if(0 == g_ps_data->selection)
		ret = psensor_factory_read_2cm(PSENSOR_2CM_CALIBRATION_FILE_2ND, &g_i2c_client->dev);
	else if(1 == g_ps_data->selection)
		ret = psensor_factory_read_3cm(PSENSOR_3CM_CALIBRATION_FILE_2ND, &g_i2c_client->dev);
	else
	...
	ret = psensor_factory_read_low(PSENSOR_LOW_CALIBRATION_FILE_2ND, &g_i2c_client->dev);	

	/*For transition period from 3/5 to 2/4 +++*/
	if(0 == g_ps_data->selection)
		ret = psensor_factory_read_4cm(PSENSOR_4CM_CALIBRATION_FILE_2ND, &g_i2c_client->dev);
	else if(1 == g_ps_data->selection)
		ret = psensor_factory_read_5cm(PSENSOR_5CM_CALIBRATION_FILE_2ND, &g_i2c_client->dev);
	else
	...
	ret = psensor_factory_read_1cm(PSENSOR_1CM_CALIBRATION_FILE_2ND, &g_i2c_client->dev);
	if(ret > 0){
...
static int light_get_accuracy_gain(void)
{
	...
	cal = lsensor_factory_read(LSENSOR_CALIBRATION_FILE_2ND, &g_i2c_client->dev);
	
	if(0 == g_als_data->selection)
		cal = lsensor_factory_read_50ms(LSENSOR_50MS_CALIBRATION_FILE_2ND, &g_i2c_client->dev);
	else if(1 == g_als_data->selection)
		cal = lsensor_factory_read_100ms(LSENSOR_100MS_CALIBRATION_FILE_2ND, &g_i2c_client->dev);
	else
...
static int mproximity_show_calibration_hi(void)
{
	...
	calvalue = psensor_factory_read_high(PSENSOR_HI_CALIBRATION_FILE_2ND, &g_i2c_client->dev);

	/*For transition period from 3/5 to 2/4 +++*/
	if(0 == g_ps_data->selection)
		calvalue = psensor_factory_read_2cm(PSENSOR_2CM_CALIBRATION_FILE_2ND, &g_i2c_client->dev);
	else if(1 == g_ps_data->selection)
		calvalue = psensor_factory_read_3cm(PSENSOR_3CM_CALIBRATION_FILE_2ND, &g_i2c_client->dev);
	else
		err("2nd INVALID selection : %d\n", g_ps_data->selection);
	/*For transition period from 3/5 to 2/4 ---*/
...
static int mproximity_store_calibration_hi(int calvalue)
{
	...
	psensor_factory_write_high(calvalue, CALIBRATION_FILE_DIR PSENSOR_HI_CALIBRATION_FILE_2ND);
	
	/*For transition period from 3/5 to 2/4 +++*/
	if(0 == g_ps_data->selection)
		psensor_factory_write_2cm(calvalue, CALIBRATION_FILE_DIR PSENSOR_2CM_CALIBRATION_FILE_2ND);
	else if(1 == g_ps_data->selection)
		psensor_factory_write_3cm(calvalue, CALIBRATION_FILE_DIR PSENSOR_3CM_CALIBRATION_FILE_2ND);
	else
		err("2nd INVALID selection : %d\n", g_ps_data->selection);
	/*For transition period from 3/5 to 2/4 ---*/
...
static int mproximity_show_calibration_lo(void)
{
	...
	calvalue = psensor_factory_read_low(PSENSOR_LOW_CALIBRATION_FILE_2ND, &g_i2c_client->dev);	

	/*For transition period from 3/5 to 2/4 +++*/
	if(0 == g_ps_data->selection)
		calvalue = psensor_factory_read_4cm(PSENSOR_4CM_CALIBRATION_FILE_2ND, &g_i2c_client->dev);
	else if(1 == g_ps_data->selection)
		calvalue = psensor_factory_read_5cm(PSENSOR_5CM_CALIBRATION_FILE_2ND, &g_i2c_client->dev);
	else
		err("2nd INVALID selection : %d\n", g_ps_data->selection);
	/*For transition period from 3/5 to 2/4 ---*/
...
static int mproximity_store_calibration_lo(int calvalue)
{
	...
	psensor_factory_write_low(calvalue, CALIBRATION_FILE_DIR PSENSOR_LOW_CALIBRATION_FILE_2ND);

	/*For transition period from 3/5 to 2/4 +++*/
	if(0 == g_ps_data->selection)
		psensor_factory_write_4cm(calvalue, CALIBRATION_FILE_DIR PSENSOR_4CM_CALIBRATION_FILE_2ND);
	else if(1 == g_ps_data->selection)
		psensor_factory_write_5cm(calvalue, CALIBRATION_FILE_DIR PSENSOR_5CM_CALIBRATION_FILE_2ND);
	else
		err("2nd INVALID selection : %d\n", g_ps_data->selection);
	/*For transition period from 3/5 to 2/4 ---*/
...
{
	int calvalue;
	calvalue = psensor_factory_read_inf(PSENSOR_INF_CALIBRATION_FILE_2ND, &g_i2c_client->dev);
...
static int mproximity_store_calibration_inf(int calvalue)
{
	...
	psensor_factory_write_inf(calvalue, CALIBRATION_FILE_DIR PSENSOR_INF_CALIBRATION_FILE_2ND);
...
static int mlight_show_calibration(void)
{
	...
	calvalue = lsensor_factory_read(LSENSOR_CALIBRATION_FILE_2ND, &g_i2c_client->dev);

	if(0 == g_als_data->selection)
		calvalue = lsensor_factory_read_50ms(LSENSOR_50MS_CALIBRATION_FILE_2ND, &g_i2c_client->dev);
	else if(1 == g_als_data->selection)
		calvalue = lsensor_factory_read_100ms(LSENSOR_100MS_CALIBRATION_FILE_2ND, &g_i2c_client->dev);
	else
		err("2nd INVALID selection : %d\n", g_als_data->selection);
...
static int mlight_store_calibration(int calvalue)
{
	...
	lsensor_factory_write(calvalue, CALIBRATION_FILE_DIR LSENSOR_CALIBRATION_FILE_2ND);

	if(0 == g_als_data->selection)
		lsensor_factory_write_50ms(calvalue, CALIBRATION_FILE_DIR LSENSOR_50MS_CALIBRATION_FILE_2ND);
	else if(1 == g_als_data->selection)
		lsensor_factory_write_100ms(calvalue, CALIBRATION_FILE_DIR LSENSOR_100MS_CALIBRATION_FILE_2ND);
	else
		err("2nd INVALID selection : %d\n", g_als_data->selection);
...
static int proximity_check_minCT(void)
{
	...
	ret = psensor_factory_read_inf(PSENSOR_INF_CALIBRATION_FILE_2ND, &g_i2c_client->dev);	
	if(ret >= 0) {
